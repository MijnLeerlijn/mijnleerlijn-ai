...
// Sales Dashboard (2026-09-13): beheerbare commerciële doelstellingen en
// partnerdossiers. Monday blijft de bron voor scholen/leads; deze tabellen
// bevatten uitsluitend lokale afspraken/doelen/logboekmetadata.
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    CREATE TABLE IF NOT EXISTS "sales_partners" (
      ...
      "status" "enum_sales_partners_status" DEFAULT 'actief',
    ...
    CREATE TABLE IF NOT EXISTS "sales_partners_mijlpalen" (
      ...
      "type" "enum_sales_partners_mijlpalen_type" NOT NULL,
    ...
    CREATE UNIQUE INDEX IF NOT EXISTS "sales_partners_naam_idx" ON "sales_partners" USING btree ("naam");
