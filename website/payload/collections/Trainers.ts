...
//    framework-afgedwongen. Een trainersaccount kan structureel nooit in de
//    gewone admin terechtkomen, ongeacht welke access-controlecode hier
//    ooit zou falen.
...
//    letterlijk "trainers" is, nooit alleen cookie-aanwezigheid.
...
//    enkel Payload-REST-pad voor "trainers" is ooit vanuit de browser
//    bereikbaar voor een trainer zelf.
// 4. maxLoginAttempts/lockTime: native Payload-mechanisme i.p.v. een eigen
//    wrapper om /api/trainers/login — dat mechanisme bestaat precies
//    hiervoor en is al door Payload zelf getest/onderhouden.
export const Trainers: CollectionConfig = {
  ...
  labels: { singular: "Trainer", plural: "Trainers" },
  admin: {
    useAsTitle: "name",
