...
// een handmatig logboekitem heeft geen Monday-writeback, geen
// idempotentiestatus, geen AI-structurering — het datamodel van
// TrainingVerslagen zou hier grotendeels ongebruikte velden meeslepen. Ook
// geen hergebruik van TrainerLogEvents (dat is systeemaudit voor de
// datum/status-schrijfback, geen trainer-geschreven inhoud).
//
