...
// eigen Next.js-app) op de publieke Helpdesk-homepage, altijd zichtbaar voor
// elke variant. `href` komt vast vanuit page.tsx (CURRICULUM_WERKPLAATS_URL,
// tijdelijk hardcoded — zie het commentaar daar) — dit component zelf blijft
// bewust onwetend van de bron, geen eigen zichtbaarheidscheck. Vast paars (CategorieIcoon
